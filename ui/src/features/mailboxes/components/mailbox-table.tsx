...
import { mailboxListKey } from '../keys';
import { deleteMailbox, listMailboxPage } from '../mailboxes.query';
...
export default function MailboxTable() {
  const list = createCursorList<MailboxInfo>(
    mailboxListKey,
    'search',
  ...
  const remover = createDeleteTarget<{ mailbox: string }>({
